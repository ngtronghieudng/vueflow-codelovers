...
<div class="el-tabs__inner">
  <el-form :model="fieldProperties" :rules="rules" :label-position="labelPosition" ref="fieldProperties">
    ...
    <el-dialog :close-on-click-modal="false" title="Advanced Options" v-model:visible="advancedPropsVisible">
...
<script>
import RatingAdvancedProps from './RatingAdvancedProps.vue'
